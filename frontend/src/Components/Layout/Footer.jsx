...
import {
    ...
    FaPhone, FaEnvelope, FaChevronRight
} from 'react-icons/fa';
                ...
                <div className={styles.footerGrid}>
                    ...
                    <div className={styles.footerColumn}>
                        ...
                        <ul className="list-unstyled">
                            <li><a href="#" className={styles.footerLink}>Property Managers</a></li>
                            <li><a href="#" className={styles.footerLink}>Residents</a></li>
                    ...
                    <div className={styles.footerColumn}>
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <a href="#" className={`${styles.footerLink} ${styles.demoLink}`}>
